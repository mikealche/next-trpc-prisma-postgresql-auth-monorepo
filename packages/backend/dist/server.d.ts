...
export declare const appRouter: import("@trpc/server/dist/declarations/src/router").Router<{
    ...
    res: import("http").ServerResponse;
}, trpc.Prefixer<trpc.Prefixer<{}, "me/">, "auth/">, trpc.Prefixer<trpc.Prefixer<{} & Record<"", import("@trpc/server/dist/declarations/src/internals/procedure").Procedure<{
    headers: import("http").IncomingHttpHeaders;
    user: import(".prisma/client").User | null;
    isAdmin: boolean | undefined;
    req: {
    ...
    token: string;
}>>, "auth/">, trpc.Prefixer<trpc.Prefixer<{}, "me/">, "auth/">, trpc.DefaultErrorShape>;
export declare type AppRouter = typeof appRouter;
export declare const server: import("http").Server, listen: (port?: number | undefined) => {
    port: number | undefined;
};
export declare const close: () => import("http").Server;
